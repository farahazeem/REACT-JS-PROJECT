...
Run frontend and backend separetely in different terminals
frontend--> npm start
backend--> npm run dev
Frontend can be listened at: http://localhost:3000/
Backend can be listened at e.g: http://localhost:5000/api/foods
Tech set we used for this project:
⦁ ReactJS,
⦁ Nodejs,
⦁ ExpressJS,
⦁ Mongodb,
