...
export default function OrderPage() {
  ...
  //to show u how this(parent) component doesnt rerender everytime the modal(child) component is open
  //i.e. the advantage of using useImperative() hook
  ...
  return (
    <>
      ...
      {/* passing the ref to the child/modal component */}
    </>
  );
}
